...
The data was retrieved from the [ -@harmon2024tidytuesdayR], with additional information on its origin available in [ -@rennie2022blog] entry, “Scraping London Marathon data with {rvest}”.
...
**OR**
**Does Category have effect on the finish time over the years?**
...
To get some inspiration, you could look at the bibliographies of 
bibliographies as well as in Dennis work around all the important 
people [ -@harmon2024tidytuesdayR].
\newpage
